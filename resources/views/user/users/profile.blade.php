...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image text-center mt-4">
                        ...
                        <img class="card-img-top img-fluid rounded-circle" style="height:80px;width:80px;" src="{{ secure_asset($profile->photo) }}" alt="profile picture">
                        @else
                        <img class="card-img-top img-fluid rounded-circle" style="height:80px;width:80px;" src="{{ secure_asset('backend/img/avatar.png') }}" alt="profile picture">
                        @endif
                    </div>
            ...
            <div class="col-md-8">
                <form enctype="multipart/form-data" class="border px-4 pt-2 pb-3" method="POST" action="{{route('user-profile-update',$profile->id)}}">
                    @csrf
