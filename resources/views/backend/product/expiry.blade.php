...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('product.expiry')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm sản phẩm</a>
    </div>
    <div class="card-body">
        ...
        <table class="table table-bordered" id="product-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            @foreach($products as $product)
              ...
              <td>{{ucfirst($product->country->title)}}</td>
              <td>{{ucfirst($product->expiry->title)}}</td>
<td>{{ucfirst($product->unit->title)}}</td>
    ...
    @endphp
    <img src="{{ secure_asset($photo[0]) }}" class="img-fluid zoom" style="max-width:80px" alt="product image">
@else
...
@endif
                     ...
                     <td>{{ \Carbon\Carbon::parse($product->year_of_manufacture)->format('d/m/Y') }}</td>
