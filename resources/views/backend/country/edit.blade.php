...
@section('title','Jelly-Boutique || Country Edit')
@section('main-content')

<div class="card">
    <h5 class="card-header">Chỉnh sửa nước SX</h5>
    <div class="card-body">
      <form method="post" action="{{route('country.update',$country->id)}}">
        ...
        <input id="inputTitle" type="text" name="title" placeholder="Enter title"  value="{{$country->title}}" class="form-control">
        @error('title')
