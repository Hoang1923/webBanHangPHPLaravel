...
<div class="product-area section">
    ...
    padding: 10px;">
                                ...
                                <div class="product-content">
                                    <h3 class="titlee"><a href="{{route('product-detail',$product->slug)}}">{{$product->title}}</a></h3>
                        ...
                        <div class="product-img">
                            <a href="{{route('product-detail',$product->slug)}}">
                                ...
                                @if($product->stock<=0)
                                    ...
                                    <span class="out-of-stock">Mới</span>
                                    @endif
                            </a>
                            <div class="button-head">
                                <div class="product-action">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="shop-single-blog">
                    <img style="width: 250px; height: 250px; object-fit: cover; object-position: center;" src="{{$post->photo}}" alt="{{$post->photo}}">

                    <div class="content">
                        <p class="date">{{$post->created_at->format('d M , Y. D')}}</p>
                        <a href="{{route('blog.detail',$post->slug)}}" class="title title_postt">{{$post->title}}</a>
