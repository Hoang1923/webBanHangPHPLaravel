...
@section('title','Jelly-Boutique || Chi Tiết Bài Viết')
            ...
            <div class="col-lg-8 col-12">
                <div class="blog-single-main">
                    <div class="row">
                        <div class="col-12">
                            <div class="image">
                                <img src="{{ secure_asset($post->photo) }}" alt="{{ $post->title }}">
                    ...
                    <p class="text-center p-5">
                        Bạn cần <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng Nhập</a> OR <a style="color:blue" href="{{route('register.form')}}">Đăng Ký</a> để bình luận.
