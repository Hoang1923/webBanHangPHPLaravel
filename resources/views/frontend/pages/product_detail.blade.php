...
@endsection
@section('title','Jelly-Boutique || Chi Tiết Sản Phẩm')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
												...
												<p class="description"> 
													<strong>Ngày sản xuất:</strong> {{ $product_detail->year_of_manufacture ? \Carbon\Carbon::parse($product_detail->year_of_manufacture)->format('d/m/Y') : 'N/A' }}<br>
													  <strong>Hạn sử dụng:</strong> {{ $product_detail->expiry ? $product_detail->expiry->title : 'N/A' }}
												</p>
																...
																<div class="ratting-main">
																	...
																	<div class="single-rating">
																		<div class="rating-author">
																			...
																			<img src="{{secure_asset($data->user_info['photo'])}}" alt="{{$data->user_info['photo']}}">
																			@else
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
											...
											@endphp
                                         <img class="default-img" src="{{ secure_asset($photo[0]) }}" alt="{{ $data->title }}">
<img class="hover-img" src="{{ secure_asset($photo[0]) }}" alt="{{ $data->title }}">
